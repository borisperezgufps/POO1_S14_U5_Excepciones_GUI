...
public class Demonstration6 {
	...
	public static void main(String[] args) {
		...
		int a = 100, b = 1;
		try {
			Demonstration6 d6 = new Demonstration6();
			d6.divide(a, b);
		} catch (Exception ex) {
		...
		/*
		 * Ojo, si se quita el try-catch, igual el método podría lanzar una 
		 * excepción, y como no se estaría capturando, entonces todo el programa
		 * se caería. Es importante hacer explícita la posibilidad de una 
		 * excepción.
		 * Vea Demostration7
		 */
	}
